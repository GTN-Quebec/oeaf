...
function Snorql() {
    ...
    this._endpoint = '${mulgara.endpoint}';
    // modify these to your likeing
    this._poweredByLink = 'http://mulgara.org/';
    this._poweredByLabel = 'Mulgara';
    ...
    this.start = function() {
        ...
        if (!queryString) {
            document.getElementById('querytext').value = 'SELECT DISTINCT ?s ?p ?o\nWHERE {\n  ?s ?p ?o\n}\nLIMIT 100';
    ...
    this._displayEndpointURL = function() {
        var newTitle = 'Sparql endpoint : ' + this._endpoint;
